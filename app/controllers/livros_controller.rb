class LivrosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @livro.save
        ...
        format.json { render action: 'show', status: :created, location: @livro }
      else
  ...
  private
    ...
    def livro_params
      params.require(:livro).permit(:titulo, :ano_da_publicacao, :autores, :cidade, :editora, :edicao, :palavras_chave)
    end
end
